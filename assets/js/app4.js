...
const messages = JSON.parse(localStorage.getItem('messagesEdi')) || []
...
<div class="d-flex ${message.sender === 'John' ? 'justify-content-end' : 'justify-content-start'}">
  <div class="message ${message.sender === 'John' ? 'blue-bg' : 'gray-bg'}">
    <div class="message-sender">${message.sender === 'John' ? '' : 'Edi Saputra, S.T., M.Sc.'}</div>
...
const sendMessage = (e) => {
  ...
  localStorage.setItem('messagesEdi', JSON.stringify(messages))
